...
import { createTicket, deleteTicketbyId, getAllTicket, updateTicketbyId } from '../../services/playgroundmanagerApi'
...
const TicketManagementContent = () => {
  ...
  return (
    <div>
      ...
      <Button onClick={handleAddTicket} className='AD-add-user-button'>
        Add Ticket
      </Button>
