...
const EventManagementContent = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    <Button className="edit-button" onClick={() => showEditEventModal(record)}>Edit</Button>
    ...
    const handleEditEvent = async (updatedEvent) => {
        try {
            ...
            setEvents((prevEvents) =>
                prevEvents.map((event) => (event._id === updateEvent._id ? updateEvent : event))
            );
            fetchEvents();
    ...
    return (
        <>
            ...
            >
                ...
                <Form.Item>
                    <Button style={{ backgroundColor: "#3b71ca", color: "white" }} onClick={handleAddEvent}>Create</Button>
                </Form.Item>
            </Form>
