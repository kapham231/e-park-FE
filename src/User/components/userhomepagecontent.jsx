...
const UserHomepageContent = () => {
	...
	const features = [
		...
		},
		{
			...
			description: "We are committed to every activity in the playground, entertaining children while stimulating creativity.",
			icon: feature3
		}
	];
	...
	return (
		<div>
			...
			<div className="us-homepage-section upcoming-event">
				...
				<Link to={"/user/event"} className="view-all-link" onClick={() => window.scrollTo(0, 0)}>View All Event →</Link>
			</div>
