    ...
    return (
        <div className="us-register-container">
            <div style={{ padding: "20px", maxWidth: "800px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "20px" }}>
                <Card title={<h2>📝 Order Information</h2>} style={{ textAlign: "left", marginTop: "20px", marginBottom: "20px" }}>
                    <Form layout="vertical" form={form}>
                        ...
                        {selectedTicket && (
                            <>
                                ...
                                >
                                    <InputNumber min={1} placeholder="Enter quantity" style={{ width: "100%" }} onChange={(value) => form.setFieldsValue({ quantity: value })} />
                                    <Alert message={'One ticket includes only one child and one parent'} type="info" showIcon style={{ marginTop: "5px" }} />
                                </Form.Item>
