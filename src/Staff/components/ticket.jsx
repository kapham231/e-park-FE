...
import { createTicketForNewMember } from '../../services/playgroundmanagerApi'
...
const Ticket = ({ ticket, onEdit, onDelete }) => {
  ...
  const generatePDF = (invoiceData) => {
    ...
    doc.text(`- ${formatCurrencyForPDF(invoiceData.tickets[0].priceAfterEventDiscount)}`, 190, startY, {
      align: 'right'
    })
    startY += 10
      ...
      <div className='ticket-content' style={{ background: ticket.backgroundColor }}>
        ...
        <Space size='middle'>
          ...
          <Popconfirm
            ...
            cancelText='No'
          >
            <Button type='primary' shape='round' size='small' className='ticket-delete-button'>
              Delete
            </Button>
          </Popconfirm> */}
          {/* Nút tạo PDF */}
