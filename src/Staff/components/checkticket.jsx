...
import { getEventByDate } from '../../services/playgroundmanagerApi'
        ...
        <Row gutter={[16, 16]} justify='center' style={{ marginTop: 20 }}>
          <Col xs={24} sm={20} md={16} lg={12} xl={10}>
            <Card>
              ...
              <p>
                <strong>Status:</strong> {renderStatusTag(invoice.status)}
              </p>
              <p>
              ...
              <ul>
                {invoice.tickets.map((ticket, index) => (
                  <React.Fragment key={index}>
                    ...
                    {ticket.bonus > 0 && <li>Bonus for this Type: {ticket.bonus} parent</li>}
                  </React.Fragment>
                ))}
              </ul>
              <p>
                <strong>Total Price:</strong> {formatCurrency(invoice.subtotal)}
              </p>
              {invoice.status !== 'PAID' && (
                <Button
