...
const roleBasedItems = {
  ...
  staff: [
    ...
    {
      key: "/staff/report-error",
      icon: <BugOutlined />,
      label: "Report Error",
    },
    {
      key: "/staff/check-ticket",
      icon: <SolutionOutlined />,
      label: "Check Ticket",
    },
    {
  ...
  manager: [
    {
      key: "/manager/event-management",
      icon: <ContainerOutlined />,
      label: "Event",
    },
    {
      key: "/manager/device-management",
      icon: <ToolOutlined />,
      label: "Device Management",
    },
    // { key: '/manager/manager-dashboard', icon: <AreaChartOutlined />, label: 'Dashboard' },
    {
      key: "/manager/product-management",
      icon: <ProductOutlined />,
      label: "Product Management",
    },
    {
      key: "/manager/voucher-management",
      icon: <TagOutlined />,
  ...
  const managerContent = (
    <Routes>
      ...
      <Route
        ...
        element={<EventManagementContent />}
      />
