      ...
      <MDBRow>
        <MDBCol md='6' className='text-center text-md-start d-flex flex-column justify-content-center'>
          ...
          <p className='px-3' style={{ color: 'hsl(218, 81%, 85%)', textAlign: 'justify' }}>
            You play a crucial role in ensuring the efficient management and security of the platform. The admin is
            responsible for creating and managing user accounts. This includes setting up new users, assigning
            permissions, and overseeing user activities to ensure the system runs smoothly and securely.
          </p>
        </MDBCol>
          ...
          <MDBCard className='my-5 bg-glass'>
            <MDBCardBody className='p-5'>
              ...
              >
                ...
                {errorMessage && <div className='w-full mb-4 note note-danger mb-3 text-danger'>{errorMessage}</div>}
